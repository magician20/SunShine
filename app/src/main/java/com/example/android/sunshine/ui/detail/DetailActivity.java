...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date date = new Date(timestamp);//SunshineDateUtils.getNormalizedUtcDateForToday();
        DetailViewModelFactory detailFactory = InjectorUtils.provideDetailViewModelFactory(
                this.getApplicationContext(), date);

        //create or return exist ViewModel object
        //look at ViewModelProviders >> takes UI controller and Factory
        mViewModel = ViewModelProviders.of(this,detailFactory).get(DetailActivityViewModel.class);
        // create observer object and assign it to LiveData object to observe
