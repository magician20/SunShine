...
public class SunshineRepository {
    ...
    private SunshineRepository(
            WeatherDao weatherDao, WeatherNetworkDataSource weatherNetworkDataSource, AppExecutors executors) {
     ...
     * return all the data
     *
     * @return LiveData<List<WeatherEntry>>
     **/
    ...
    /**
     * Database related operations get data by date
     *
     * @return LiveData<WeatherEntry>
     **/
