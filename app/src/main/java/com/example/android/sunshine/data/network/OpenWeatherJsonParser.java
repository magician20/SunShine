...
final class OpenWeatherJsonParser {
    ...
    private static WeatherEntry fromJson(final JSONObject dayForecast,
        ...
        // Create the weather entry object idk why not run constrctor without _ID
        return new WeatherEntry(
                weatherId, new Date(dateTimeMillis), min,max,humidity, pressure, windSpeed, windDirection);
    }
